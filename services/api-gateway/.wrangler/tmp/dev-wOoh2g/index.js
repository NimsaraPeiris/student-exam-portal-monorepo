...
// .wrangler/tmp/bundle-QTInEN/checked-fetch.js
...
app.all("/auth/*", async (c) => {
  ...
  return fetch(targetUrl, {
    ...
    body: c.req.method !== "GET" ? await c.req.arrayBuffer() : void 0
  });
});
...
// .wrangler/tmp/bundle-QTInEN/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-QTInEN/middleware-loader.entry.ts
