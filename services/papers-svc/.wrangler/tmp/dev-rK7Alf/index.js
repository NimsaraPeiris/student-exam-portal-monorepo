...
// .wrangler/tmp/bundle-EWfSvm/checked-fetch.js
...
app.get("/papers", async (c) => {
  ...
  let baseQuery = db.select().from(papers);
  if (filters.length > 0) {
...
// .wrangler/tmp/bundle-EWfSvm/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-EWfSvm/middleware-loader.entry.ts
